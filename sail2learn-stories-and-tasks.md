...
This document organizes our SEO strategy into actionable Agile "User Stories" and a prioritized Task Backlog. It serves as a central hub for tracking what needs to be done, what is in progress, and long-term growth initiatives. The stories are ordered by **Criticality and Impact**.

---

## 🏃‍♂️ SPRINT 1: The Critical Path (High Impact / Do Immediately)
...
**Story 2: As a visitor landing on the homepage, I want a clear, immediate way to contact the instructor or book a lesson (Conversion Rate Optimization).**
- [ ] Add a highly visible "Book Your Sail" or "Contact Captain Steve" button "Above the Fold" on the homepage
- [ ] Remove the plain text email address from the site (to prevent bot scraping/spam)
- [ ] Create a Squarespace Contact Form (Name, Dates, Experience Level) for the button to link to
- [ ] Set up a free Google Voice number to route to the owner's cell phone (blocks spam calls)
- [ ] Display the Google Voice number below the contact form for immediate questions

**Story 3: As Googlebot, I need to understand what the homepage is about so I can rank it for the correct local keywords.**
...
**Story 4: As a mobile user on a 3G connection, I need the site to load in under 3 seconds so I don't leave out of frustration.**
...
**Story 5: As a brand, I want my logo to appear next to my link in Google search results to increase click-through rate.**
...
## 🚶‍♂️ SPRINT 2: Building E-E-A-T, AI, & Tracking (Moderate Impact)

**Story 6: As a business owner, I need to measure the success of my SEO efforts and track how users find my site.**
...
**Story 7: As an AI Engine (ChatGPT/Gemini), I need structured data to mathematically verify the business details and course offerings.**
- [ ] Gather public phone number from owner (Use the new Google Voice number)
...
**Story 8: As an AI Engine, I need proof that the instructor is a verified expert so I can confidently recommend him.**
...
**Story 9: As a user asking conversational questions to AI, I want direct answers about the sailing lessons.**
...
**Story 10: As the business owner, I want to eliminate Squarespace platform limitations so I can achieve a 100/100 performance score and deploy new pages instantly with AI.**
- [ ] Review the `migration-planning/squarespace-to-code-migration.md` document
...
**Story 11: As a local business, I want to establish Topical Authority so I rank for all sailing-related searches in Southwest Florida.**
